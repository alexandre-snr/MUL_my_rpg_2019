...
void add_little_tree_snow(scene_t *scn, engine_t *engine, sfVector2f pos)
{
    ...
    snr_scene_add_entity(scn, NULL, create_obstacle(
    "game/assets/sprites/obstacles/small_tree_snow.png", &pos, &rect), "Tree");
}
...
{
    sfFloatRect rect = {pos.x + 5, pos.y + 20, 37, 34};

    snr_scene_add_entity(scn, engine, create_obstacle(
    "game/assets/sprites/obstacles/crate1.png", &pos, &rect), "Crate 1");
}